...
class KtsScratchFileEditorProvider : FileEditorProvider, DumbAware {
    ...
    override fun createEditor(project: Project, file: VirtualFile): FileEditor {
        ...
        return KtsScratchFileEditorWithPreview.create(scratchFile)
    }
...
class KtsScratchFileEditorWithPreview private constructor(
    ...
    companion object {
        fun create(scratchFile: ScratchFile): KtsScratchFileEditorWithPreview {
            ...
            return KtsScratchFileEditorWithPreview(scratchFile, mainEditor, previewEditor)
        }
    }
}

fun TextEditor.findScratchFileEditorWithPreview(): KtsScratchFileEditorWithPreview? =
    if (this is KtsScratchFileEditorWithPreview) this else parentScratchEditorWithPreview

private var TextEditor.parentScratchEditorWithPreview: KtsScratchFileEditorWithPreview?
