 ...
 */
class PreviewEditorScratchOutputHandler(private val previewTextEditor: TextEditor) : ScratchOutputHandler {
    private val toolwindowHandler: ScratchOutputHandler = getToolwindowHandler(previewTextEditor)
