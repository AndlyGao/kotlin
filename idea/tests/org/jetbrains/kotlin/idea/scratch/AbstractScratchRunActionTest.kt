...
abstract class AbstractScratchRunActionTest : FileEditorManagerTestCase() {
    ...
    private fun getPreviewTextWithFoldings(): String {
        ...
        val previewEditor = scratchFileEditor.previewTextEditor
        return CodeInsightTestFixtureImpl.getFoldingData(previewEditor.editor, /*withCollapseData=*/false)
    }
    ...
    protected fun configureScratchByText(name: String, text: String): ScratchFile {
        ...
        val scratchFile = getScratchEditorForSelectedFile(myManager, myFixture.file.virtualFile)
            ?: error("Couldn't find scratch file")

        configureOptions(scratchFile, text, myFixture.module)

        return scratchFile.scratchFile
    }
    ...
    companion object {
        ...
        fun configureOptions(
            scratchFileEditor: KtsScratchFileEditorWithPreview,
            fileText: String,
            module: Module?
        ) {
